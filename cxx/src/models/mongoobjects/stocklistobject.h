#ifndef STOCKLISTOBJECT_H
#define STOCKLISTOBJECT_H

#include <QSharedData>
#include <TMongoObject>

class T_MODEL_EXPORT StockListObject : public TMongoObject, public QSharedData
{
public:
    QString _id;
    QString code;
    ...
    virtual QString collectionName() const override { return QStringLiteral("stock_list"); }
