#ifndef INDEXMINOBJECT_H
#define INDEXMINOBJECT_H

#include <QSharedData>
#include <TMongoObject>

class T_MODEL_EXPORT IndexMinObject : public TMongoObject, public QSharedData
{
public:
    QString _id;
    double open;
    ...
    virtual QString collectionName() const override { return QStringLiteral("index_min"); }
...
private:
    ...
    Q_PROPERTY(qint32 up_count READ getup_count WRITE setup_count)
    T_DEFINE_PROPERTY(qint32, up_count)
    Q_PROPERTY(qint32 down_count READ getdown_count WRITE setdown_count)
    T_DEFINE_PROPERTY(qint32, down_count)
