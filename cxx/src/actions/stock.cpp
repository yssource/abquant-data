...
template <class SA>
QList<S> StockActionPrivate<SA>::run(const QStringList codes, const char* start, const char* end)
{
...
template <class SA>
QList<S> StockActionPrivate<SA>::run(const QStringList codes, int category)
{
...
template <class SA>
QList<S> StockActionPrivate<SA>::get_price(const QStringList codes, const char* start, const char* end)
{
...
template <class SA>
QList<S> StockActionPrivate<SA>::get_price(const QStringList codes, int category)
{
    // auto sa = static_cast<SA *>(this);
    auto sa = derived_cast();
    TDatabaseContext::setCurrentDatabaseContext(sa);
